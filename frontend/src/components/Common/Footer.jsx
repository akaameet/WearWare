...
const Footer = () => {
  return <footer className='border-t py-12 px-8'>
  <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
    <div >
        <h3 className='text-lg text-gray-800 mb-4 '>Newsletter</h3>
        <p className='text-gray-500 mb-4' >
            Be the first to hear about new products, exclusiive events, and online offers.
        </p>
        <p className='font-medium text-sm text-gray-600 mb-6'> Sign up and get 10% on first order.</p>
        ...
        <form className='flex'>
            ...
            focus:outline-none focus:ring-2  focus:ring-gray-00 transition-all' required />
            <button type='submit' className='text-white bg-black hover:bg-gray-600 
            rounded-r-md text-sm px-6 py-3 transition-all'>Subscribe </button>
        </form>
    </div>
    ...
    <div>
     ...
     <div className='flex items-center space-x-4 mb-6'>
        ...
        rel='noopener noreferrror' className='hover:text-gray-300'>
            <TbBrandMeta className='h-5 w-5'/>
        </a>
        <a href='https://www.instagram.com' type='_blank' 
        rel='noopener noreferrror' className='hover:text-gray-300'>
            <IoLogoInstagram className='h-5 w-5'/>
        </a>
        <a href='https://www.classroom.com' type='_blank' 
        rel='noopener noreferrror' className='hover:text-gray-300'>
   ...
   <p className='text-gray-500 text-sm tracking-tighter text-center'>@2025, WearWare. All Rights Reserved.</p>
