...
const Checkout = () => {
  ...
  const handleCreateCheckout = (e) => {
    ...
    // Optional: validate required fields before continuing
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto py-10 px-6">
        ...
        <form onSubmit={handleCreateCheckout}>
          ...
          <div className="mt-6">
            {!checkoutStarted ? (
              ...
              <div>
                <h3 className="text-lg mb-4 font-semibold">Pay with eSewa</h3>
                <Payment
      ...
      <div className='flex justify-between items-center text-lg mb'>
        <p>Shipping</p>
        <p>Free</p>
      </div>
